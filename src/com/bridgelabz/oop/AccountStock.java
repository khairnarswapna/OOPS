...
import com.bridgelabz.oops.Model.Company;
import com.bridgelabz.oops.Model.CompanyModel;
import com.bridgelabz.oops.Model.Customer;
import com.bridgelabz.oops.Model.CustomerModel;
import com.bridgelabz.oops.Model.TransactionModel;
import com.bridgelabz.oops.Model.Transactions;
...
public class AccountStock {
	...
	/*public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		compModel = (CompanyModel) JsonUtility.readMapper(pathOfCompanyShares, compModel);

		// code for fetching the customer info
		
		custModel = (CustomerModel) JsonUtility.readMapper(pathOfCustomerInfo, custModel);
					...
					if (isfound) 
					{
						...
						if (numOfCompanyShareToBuy < compList.get(index).getCompany_shares()) 
						{
							...
							if (customerBalance > (numOfCompanyShareToBuy * compList.get(index).getCompany_share_price())) 
							{
								...
								//String transId = custList.get(indexOfCustomer).getCustomer_id() + compList.get(index).getCompany_symbol();
